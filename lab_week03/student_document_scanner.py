...
class DocumentScanner:
    ...
    def detect_edges(self, image):
        ...
        # Close small gaps so a slightly broken page/plaque outline still forms
        # one contour (needed for case2: hands + wood grain split the border).
    ...
    def scan_document(self, image_path, show_intermediate=False):
        ...
        # 4. Contour extraction and filtering
